...
export const FETCH_FAVORITE_REQUEST = 'FETCH_FAVORITES_REQUEST';
export const FETCH_FAVORITE_SUCCESS = 'FETCH_FAVORITES_SUCCESS';
export const FETCH_FAVORITE_ERROR = 'FETCH_FAVORITES_ERROR';
